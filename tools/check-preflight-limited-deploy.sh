...
jq -n --arg configHash "$DEPLOY_CONFIG_HASH" '
  {
    ...
    spotAdapterCreationCodeHash: "0xcccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc",
    conditionalAdapterCreationCodeHash: "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
