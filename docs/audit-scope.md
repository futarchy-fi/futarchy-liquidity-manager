...
- `V4ConditionalLiquidityAdapter`: manager-bound direct v4 position owner. It atomically initializes
  ...
  live v4 donations before and after a one-third unresolved redemption, pro-rata fee allocation,
  and final-holder conservation together with the real v3 spot position manager and production
  guard.
