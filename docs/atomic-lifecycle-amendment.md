...
| A single-leg v4 donation accrues after a holder exits | The exited balances stay fixed; the surviving shares receive only the donated outcome side, and settlement does not invent value in the undonated base asset. |
