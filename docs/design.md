...
production spot guard are exercised together; remaining configuration is recorded in
`production-mainnet-dependency-manifest.md`, but is not yet a final selection. This therefore
