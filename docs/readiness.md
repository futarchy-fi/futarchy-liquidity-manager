...
- The current 253-test instrumented suite also passes Foundry's coverage profile with `--ir-minimum`
...
- The current 254-test normal suite includes direct emergency-handler reachability, nine
